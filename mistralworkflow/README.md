...
## API Server (Clause integration)

This powers the Clause chatbot with real AI responses:

```bash
make start-api
```

The server runs on `http://localhost:8833`. The Clause React app (`../`) will call this server for chat completions.
